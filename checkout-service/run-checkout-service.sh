...
export OTEL_RESOURCE_ATTRIBUTES="service.name=checkout-service,service.namespace=com-shoppingcart,service.version=1.0-SNAPSHOT,deployment.environment=$OPEN_TELEMETRY_DEPLOYMENT_ENVIRONMENT"
