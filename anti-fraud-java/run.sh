...
export OTEL_RESOURCE_ATTRIBUTES=service.name=anti-fraud_jaeger,service.namespace=com-shoppingcart,service.version=1.0-SNAPSHOT
...
# export OTEL_RESOURCE_ATTRIBUTES=service.name=anti-fraud_otlp,service.namespace=com-shoppingcart,service.version=1.0-SNAPSHOT
...
java -javaagent:$OPEN_TELEMETRY_AGENT_JAR \
     ...
     -Dota.exporter.jaeger.service.name=anti-fraud_jaeger \
     -Dserver.port=8081 \
